...
public class fanForgot extends AppCompatActivity {
    //declaring variables
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_forgot);

        //set variables to elements on interface
        etEmail = (EditText) findViewById(R.id.etFanForgotEmail);
        btnReset = (Button) findViewById(R.id.btnFanForgotEmail);
            ...
            Auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(fanForgot.this, "Check your email for password reset", Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(fanForgot.this, "Oops, something went wrong", Toast.LENGTH_LONG).show();
                    }
                }
            });
    }
