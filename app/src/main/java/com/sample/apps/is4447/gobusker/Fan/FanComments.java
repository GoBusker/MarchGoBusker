...
import com.sample.apps.is4447.gobusker.Adapter.FanCommentAdapter;
...
public class FanComments extends AppCompatActivity {
    ...
    private FanCommentAdapter commentAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fan_comments);
        ...
        commentAdapter = new FanCommentAdapter(this, commentList);
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (addcomment.getText().toString().equals("")){
                    Toast.makeText(FanComments.this, "", Toast.LENGTH_SHORT).show();
                } else {
                    addComment();
                }
            }
