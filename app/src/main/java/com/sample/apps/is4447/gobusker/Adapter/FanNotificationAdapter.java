...
public class FanNotificationAdapter extends RecyclerView.Adapter<FanNotificationAdapter.ViewHolder> {

    private Context mContext;
    private List<BuskerNotifications> mNotifications;

    public FanNotificationAdapter(Context mContext, List<BuskerNotifications> mNotifications) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new FanNotificationAdapter.ViewHolder(view);
    }
